...
def pkgs():
        ...
        love("\033[1;93m❍❍❍❍❍~~~~~~❍❍❍✬✥✬❍❍❍~~~~~~❍❍❍❍❍")
        love("\033[1;93m៚CREATOR : BABA KHATRAツ")
        love("\033[1;93m៚COUNTRY : NEPAL⚒⚒")
        love("\033[1;93m៚NEPALI  : HACKER✦✮")
        love("\033[1;93m៚DESIGNER; RAHUL MISHRA")
        love("\033[1;93m៚ⓓⓞⓝⓣ ⓒⓞⓟⓨ ⓜⓨ ⓢⓒⓡⓘⓟⓣ")
        love("\033[1;91m«------------------ BABA  KHATRA ----------------»")
        love("\033[1;95m✾●~~~●●✦WELLCOM TO BABA KHATRA✦●●~~~●✾")
...
def menu():
    ...
    os.system('echo ----------------BABA    KHATRA-----------------| lolcat')
